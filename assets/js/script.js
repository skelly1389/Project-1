...
function getLocation(){
  ...
  function getWeather(lon,lat,loc){
    ...
    document.getElementById("weather-card").appendChild(data.data[0].precip);
    document.getElementById("weather-card").appendChild(data.data[0].rh);
    document.getElementById("weather-card").appendChild(data.data[0].uv);
    document.getElementById("weather-card").appendChild(data.data[0].wind_spd);
    })
  }
